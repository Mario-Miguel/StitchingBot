...
class SewingMachinesListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvMachinesList.adapter =
            SewingMachinesListAdapter(sewingMachineController.getAllSewingMachines(requireContext())) { machine ->
                navigateToCreation(machine)
            }
    }
    ...
    /**
     * Envía al usuario al  fragment SewingMachineDetailsFragment
     *
     * @param machine maquina de coser seleccionada
     */
